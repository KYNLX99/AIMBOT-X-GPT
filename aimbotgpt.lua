...
-- Native Roblox UI untuk menggambar lingkaran FOV.
-- Tidak membutuhkan Drawing API.
...
local function FindClosestTarget()
	...
	-- TIDAK menggunakan mouse position.
	-- Target dihitung berdasarkan titik tengah layar.
...
local function AimAtTarget(player)
	...
	-- Posisi target selalu diperbarui
	-- agar tracking lebih stabil.
	local targetPosition =
		targetPart.Position
